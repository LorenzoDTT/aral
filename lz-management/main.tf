...
module "control_tower_controls" {
  source   = "git::codecommit::us-east-1://lz-modules.git//management-ct-controls"
...
module "permission_sets" {
  source    = "git::codecommit::us-east-1://lz-modules.git//management-permission-sets"
...
module "account-assignmets" {
  source     = "git::codecommit::us-east-1://lz-modules.git//management-account-assignments"
  providers  = { aws = aws.us_east_1 }
